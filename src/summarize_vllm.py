...
def vllm_healthcheck(base_url: str = "http://127.0.0.1:8001/v1", api_key: str = "vllm-key", timeout: int = 5) -> bool:
    """vLLM 서버의 OpenAI 호환 엔드포인트 상태 확인"""
    try:
        # vLLM/OpenAI 호환 API는 /models 엔드포인트를 제공합니다.
